...
if(inittext == 0)
{
	...
	/// @DnDArgument : "var" ""Yeah, those were good times, I don't know why but I feel i'll never experience it again...""
	draw_text(100, 700, string("Bubbles: ") + string("Yeah, those were good times, I don't know why but I feel i'll never experience it again..."));
}
...
if(playerchoices1 == 0)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "500"
	/// @DnDArgument : "caption" ""Go find a new friend""
	draw_text(150, 500, string("Go find a new friend") + "");
}
...
if(playerchoices1 == 1)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "520"
	/// @DnDArgument : "caption" ""Goodbye, Bubbles""
	draw_text(150, 520, string("Goodbye, Bubbles") + "");
}
...
if(playerchoices1 == 2)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "540"
	/// @DnDArgument : "caption" ""Let's go fishing together one day, just believe in me""
	draw_text(150, 540, string("Let's go fishing together one day, just believe in me") + "");
}
...
if (l7FCBE617_0)
{
	...
	if(playerchoices1 == 2)
	{
		...
		/// @DnDHash : 4FB1F6A6
		/// @DnDParent : 000E2D2D
		/// @DnDArgument : "room" "rm_bubbleswait"
		/// @DnDSaveInfo : "room" "0b1b56bf-714c-4c59-9c9d-391f803ec6e9"
		room_goto(rm_bubbleswait);
	}
}
...
if(crabkingmmchoice == 1)
{
	...
	/// @DnDArgument : "y" "700"
	/// @DnDArgument : "caption" ""Bubbles: ""
	/// @DnDArgument : "var" ""You know how hard is it for me to even have a single friend?""
	draw_text(512, 700, string("Bubbles: ") + string("You know how hard is it for me to even have a single friend?"));
}
...
if(crabkingmmchoice == 2)
{
	...
	/// @DnDArgument : "y" "700"
	/// @DnDArgument : "caption" ""Bubbles: ""
	/// @DnDArgument : "var" ""But I don't want you to leave.""
	draw_text(512, 700, string("Bubbles: ") + string("But I don't want you to leave."));
}