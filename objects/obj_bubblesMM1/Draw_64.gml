...
if(playerchoices1 == 0)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "500"
	/// @DnDArgument : "caption" ""Call it Blue Torpedo""
	draw_text(150, 500, string("Call it Blue Torpedo") + "");
}
...
if(playerchoices1 == 2)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "540"
	/// @DnDArgument : "caption" ""Call it Bubbles""
	draw_text(150, 540, string("Call it Bubbles") + "");
}
...
if (l7FCBE617_0)
{
	...
	if(playerchoices1 == 0)
	{
		...
		/// @DnDHash : 4FB1F6A6
		/// @DnDParent : 34AB834F
		/// @DnDArgument : "room" "rm_bubblesinteract2"
		/// @DnDSaveInfo : "room" "324c157e-7e55-40b4-900b-fcdd05b0fa38"
		room_goto(rm_bubblesinteract2);
	}
...
if(crabkingmmchoice == 1)
{
	...
	/// @DnDArgument : "var" ""I see you survived my fish, Wally, please leave me alone.""
	draw_text(512, 700, string("Bubbles: ") + string("I see you survived my fish, Wally, please leave me alone."));
}
...
if(crabkingmmchoice == 2)
{
	...
	/// @DnDArgument : "y" "700"
	/// @DnDArgument : "caption" ""Bubbles: ""
	/// @DnDArgument : "var" ""GET OUT I DON'T NEED YOUR HELP""
	draw_text(512, 700, string("Bubbles: ") + string("GET OUT I DON'T NEED YOUR HELP"));
}