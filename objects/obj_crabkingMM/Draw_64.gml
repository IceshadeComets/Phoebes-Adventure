...
if(playerchoices1 == 1)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "520"
	/// @DnDArgument : "caption" ""Insult""
	draw_text(150, 520, string("Insult") + "");
}
...
if(playerchoices1 == 2)
{
	...
	/// @DnDArgument : "x" "150"
	/// @DnDArgument : "y" "540"
	/// @DnDArgument : "caption" ""Salivate""
	draw_text(150, 540, string("Salivate") + "");
}
...
if (l7FCBE617_0)
{
	...
	if(playerchoices1 == 2)
	{
		...
		/// @DnDHash : 4FB1F6A6
		/// @DnDParent : 000E2D2D
		/// @DnDArgument : "room" "rm_crabkinginteract1"
		/// @DnDSaveInfo : "room" "14f0fdc8-3d37-404e-9f54-cdd415aa6ecd"
		room_goto(rm_crabkinginteract1);
	}
}
...
if(crabkingmmchoice == 1)
{
	...
	/// @DnDArgument : "x" "512"
	/// @DnDArgument : "y" "700"
	/// @DnDArgument : "caption" ""Crab King: ""
	/// @DnDArgument : "var" ""Ah Hello Old Man""
	draw_text(512, 700, string("Crab King: ") + string("Ah Hello Old Man"));
}
...
if(crabkingmmchoice == 2)
{
	...
	/// @DnDArgument : "y" "700"
	/// @DnDArgument : "caption" ""Crab King: ""
	/// @DnDArgument : "var" ""Go Away SNAP SNAP SNAP""
	draw_text(512, 700, string("Crab King: ") + string("Go Away SNAP SNAP SNAP"));
}